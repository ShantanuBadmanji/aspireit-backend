...
# keep below line to ensure the API key is set as an environment variable
assert OPENAI_API_KEY, "Please set your OpenAI API Key as an environment variable."
