...
async def generate_questions(request: TopicRequest):
    ...
    try:
        ...
        node_server_url = "http://localhost:5002/api/questions/"
        ...
        raise HTTPException(status_code=500, detail=f"Failed to communicate with Node.js server: {str(e)}")
